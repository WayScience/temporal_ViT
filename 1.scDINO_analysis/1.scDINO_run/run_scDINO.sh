...
snakemake -s only_downstream_snakefile --configfile="only_downstream_analyses.yaml" --until compute_CLS_features --cores 2 --rerun-incomplete > logs/CLS_token_run.log 2>&1 > logs/CLS_token_run.log 2>&1
